 ...
 */
class Address extends \Core\Model\Address implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\Model\\Address' . "\0" . 'id', '' . "\0" . 'Core\\Model\\Address' . "\0" . 'label', '' . "\0" . 'Core\\Model\\Address' . "\0" . 'address', '' . "\0" . 'Core\\Model\\Address' . "\0" . 'city', '' . "\0" . 'Core\\Model\\Address' . "\0" . 'state', '' . "\0" . 'Core\\Model\\Address' . "\0" . 'zip', '' . "\0" . 'Core\\Model\\Address' . "\0" . 'country', '' . "\0" . 'Core\\Model\\Address' . "\0" . 'contact');
        }
