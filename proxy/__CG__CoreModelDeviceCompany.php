 ...
 */
class DeviceCompany extends \Core\Model\DeviceCompany implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\Model\\DeviceCompany' . "\0" . 'id', '' . "\0" . 'Core\\Model\\DeviceCompany' . "\0" . 'device', '' . "\0" . 'Core\\Model\\DeviceCompany' . "\0" . 'company');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DeviceCompany $proxy) {
