 ...
 */
class Email extends \Core\Model\Email implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\Model\\Email' . "\0" . 'id', '' . "\0" . 'Core\\Model\\Email' . "\0" . 'label', '' . "\0" . 'Core\\Model\\Email' . "\0" . 'email', '' . "\0" . 'Core\\Model\\Email' . "\0" . 'contact');
        }
