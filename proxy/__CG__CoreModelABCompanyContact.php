    ...
    public function __sleep () {
        ...
        if ($this->__isInitialized__) {
            return array('__isInitialized__',
                         '' . "\0" . 'Core\\Model\\ABCompanyContact' . "\0" . 'id',
                         '' . "\0" . 'Core\\Model\\ABCompanyContact' . "\0" . 'type',
                         '' . "\0" . 'Core\\Model\\ABCompanyContact' . "\0" . 'order',
                         '' . "\0" . 'Core\\Model\\ABCompanyContact' . "\0" . 'contact',
                         '' . "\0" . 'Core\\Model\\ABCompanyContact' . "\0" . 'abcompany',
                         '' . "\0" . 'Core\\Model\\ABCompanyContact' . "\0" . 'abperson'
            );
        }
