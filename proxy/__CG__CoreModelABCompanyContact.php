 ...
 */
class ABCompanyContact extends \Core\Model\ABCompanyContact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\Model\\ABCompanyContact' . "\0" . 'id', '' . "\0" . 'Core\\Model\\ABCompanyContact' . "\0" . 'type', '' . "\0" . 'Core\\Model\\ABCompanyContact' . "\0" . 'order', '' . "\0" . 'Core\\Model\\ABCompanyContact' . "\0" . 'contact', '' . "\0" . 'Core\\Model\\ABCompanyContact' . "\0" . 'abcompany', '' . "\0" . 'Core\\Model\\ABCompanyContact' . "\0" . 'abperson');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ABCompanyContact $proxy) {
    ...
    public function setAbperson(\Core\Model\ABPerson $abperson = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAbperson', array($abperson));

        return parent::setAbperson($abperson);
    }
    ...
    public function getAbperson()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAbperson', array());

        return parent::getAbperson();
    }
