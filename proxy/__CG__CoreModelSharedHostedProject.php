 ...
 */
class SharedHostedProject extends \Core\Model\SharedHostedProject implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\Model\\SharedHostedProject' . "\0" . 'permission', '' . "\0" . 'Core\\Model\\SharedHostedProject' . "\0" . 'participant', '' . "\0" . 'Core\\Model\\SharedHostedProject' . "\0" . 'hostedProject');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SharedHostedProject $proxy) {
