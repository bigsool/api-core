 ...
 */
class ProjectPerson extends \Core\Model\ProjectPerson implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\Model\\ProjectPerson' . "\0" . 'id', '' . "\0" . 'Core\\Model\\ProjectPerson' . "\0" . 'name', '' . "\0" . 'Core\\Model\\ProjectPerson' . "\0" . 'address', '' . "\0" . 'Core\\Model\\ProjectPerson' . "\0" . 'phone', '' . "\0" . 'Core\\Model\\ProjectPerson' . "\0" . 'mobile', '' . "\0" . 'Core\\Model\\ProjectPerson' . "\0" . 'fax', '' . "\0" . 'Core\\Model\\ProjectPerson' . "\0" . 'email', '' . "\0" . 'Core\\Model\\ProjectPerson' . "\0" . 'company', '' . "\0" . 'Core\\Model\\ProjectPerson' . "\0" . 'abbreviation', '' . "\0" . 'Core\\Model\\ProjectPerson' . "\0" . 'creator');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectPerson $proxy) {
