...
class ABPerson extends \Core\Model\ABPerson implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\Model\\ABPerson' . "\0" . 'id', '' . "\0" . 'Core\\Model\\ABPerson' . "\0" . 'lastName', '' . "\0" . 'Core\\Model\\ABPerson' . "\0" . 'firstName', '' . "\0" . 'Core\\Model\\ABPerson' . "\0" . 'title', '' . "\0" . 'Core\\Model\\ABPerson' . "\0" . 'abcompanyContact', '' . "\0" . 'Core\\Model\\ABPerson' . "\0" . 'abpersonContact', '' . "\0" . 'Core\\Model\\ABPerson' . "\0" . 'abcompany');
        }
    ...
    public function addAbcompanyContact(\Core\Model\ABCompanyContact $abcompanyContact)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAbcompanyContact', array($abcompanyContact));
    ...
    public function removeAbcompanyContact(\Core\Model\ABCompanyContact $abcompanyContact)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeAbcompanyContact', array($abcompanyContact));
    ...
    public function addAbpersonContact(\Core\Model\ABPersonContact $abpersonContact)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAbpersonContact', array($abpersonContact));
    ...
    public function removeAbpersonContact(\Core\Model\ABPersonContact $abpersonContact)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeAbpersonContact', array($abpersonContact));
