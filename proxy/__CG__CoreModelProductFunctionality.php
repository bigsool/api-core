 ...
 */
class ProductFunctionality extends \Core\Model\ProductFunctionality implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\Model\\ProductFunctionality' . "\0" . 'quantity', '' . "\0" . 'Core\\Model\\ProductFunctionality' . "\0" . 'functionality', '' . "\0" . 'Core\\Model\\ProductFunctionality' . "\0" . 'product');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductFunctionality $proxy) {
