 ...
 */
class Phone extends \Core\Model\Phone implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\Model\\Phone' . "\0" . 'id', '' . "\0" . 'Core\\Model\\Phone' . "\0" . 'label', '' . "\0" . 'Core\\Model\\Phone' . "\0" . 'phone', '' . "\0" . 'Core\\Model\\Phone' . "\0" . 'contact');
        }
