 ...
 */
class ProjectRole extends \Core\Model\ProjectRole implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\Model\\ProjectRole' . "\0" . 'id', '' . "\0" . 'Core\\Model\\ProjectRole' . "\0" . 'label', '' . "\0" . 'Core\\Model\\ProjectRole' . "\0" . 'userProjectRoles');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectRole $proxy) {
