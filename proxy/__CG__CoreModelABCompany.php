 ...
 */
class ABCompany extends \Core\Model\ABCompany implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\Model\\ABCompany' . "\0" . 'id', '' . "\0" . 'Core\\Model\\ABCompany' . "\0" . 'name', '' . "\0" . 'Core\\Model\\ABCompany' . "\0" . 'persons', '' . "\0" . 'Core\\Model\\ABCompany' . "\0" . 'abcompanyContact');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ABCompany $proxy) {
