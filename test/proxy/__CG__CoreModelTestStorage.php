    ...
    public function __sleep () {
        ...
        if ($this->__isInitialized__) {
            return array('__isInitialized__',
                         '' . "\0" . 'Core\\Model\\TestStorage' . "\0" . 'id',
                         '' . "\0" . 'Core\\Model\\TestStorage' . "\0" . 'url',
                         '' . "\0" . 'Core\\Model\\TestStorage' . "\0" . 'login',
                         '' . "\0" . 'Core\\Model\\TestStorage' . "\0" . 'password',
                         '' . "\0" . 'Core\\Model\\TestStorage' . "\0" . 'usedSpace',
                         '' . "\0" . 'Core\\Model\\TestStorage' . "\0" . 'lastUsedSpaceUpdate',
                         '' . "\0" . 'Core\\Model\\TestStorage' . "\0" . 'isOutOfQuota',
                         '' . "\0" . 'Core\\Model\\TestStorage' . "\0" . 'company',
                         '' . "\0" . 'Core\\Model\\TestStorage' . "\0" . 'user'
            );
        }
