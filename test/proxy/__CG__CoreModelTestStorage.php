...
class TestStorage extends \Core\Model\TestStorage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'findQueryContext', 'id', 'url', 'login', 'password', 'usedSpace', 'lastUsedSpaceUpdate', 'isOutOfQuota', 'company', 'companyRestrictedId', 'isCompanyFaulted', 'user', 'userRestrictedId', 'isUserFaulted');
        }
