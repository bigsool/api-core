...
class TestCompany extends \Core\Model\TestCompany implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'findQueryContext', 'id', 'name', 'address', 'zipCode', 'city', 'state', 'country', 'tel', 'fax', 'tva', 'owner', 'ownerRestrictedId', 'isOwnerFaulted', 'storage', 'storageRestrictedId', 'isStorageFaulted', 'users', 'usersRestrictedIds', 'isUsersFaulted');
        }
