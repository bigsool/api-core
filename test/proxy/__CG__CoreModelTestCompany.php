...
class TestCompany extends \Core\Model\TestCompany implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\Model\\TestCompany' . "\0" . 'id', '' . "\0" . 'Core\\Model\\TestCompany' . "\0" . 'name', '' . "\0" . 'Core\\Model\\TestCompany' . "\0" . 'address', '' . "\0" . 'Core\\Model\\TestCompany' . "\0" . 'zipCode', '' . "\0" . 'Core\\Model\\TestCompany' . "\0" . 'city', '' . "\0" . 'Core\\Model\\TestCompany' . "\0" . 'state', '' . "\0" . 'Core\\Model\\TestCompany' . "\0" . 'country', '' . "\0" . 'Core\\Model\\TestCompany' . "\0" . 'tel', '' . "\0" . 'Core\\Model\\TestCompany' . "\0" . 'fax', '' . "\0" . 'Core\\Model\\TestCompany' . "\0" . 'tva', '' . "\0" . 'Core\\Model\\TestCompany' . "\0" . 'owner', '' . "\0" . 'Core\\Model\\TestCompany' . "\0" . 'ownerRestrictedId', '' . "\0" . 'Core\\Model\\TestCompany' . "\0" . 'storage', '' . "\0" . 'Core\\Model\\TestCompany' . "\0" . 'storageRestrictedId', '' . "\0" . 'Core\\Model\\TestCompany' . "\0" . 'users', '' . "\0" . 'Core\\Model\\TestCompany' . "\0" . 'usersRestrictedIds');
        }
