    ...
    public function __sleep () {
        ...
        if ($this->__isInitialized__) {
            return array('__isInitialized__',
                         '' . "\0" . 'Core\\Model\\TestUser' . "\0" . 'id',
                         '' . "\0" . 'Core\\Model\\TestUser' . "\0" . 'email',
                         '' . "\0" . 'Core\\Model\\TestUser' . "\0" . 'password',
                         '' . "\0" . 'Core\\Model\\TestUser' . "\0" . 'name',
                         '' . "\0" . 'Core\\Model\\TestUser' . "\0" . 'firstname',
                         '' . "\0" . 'Core\\Model\\TestUser' . "\0" . 'lang',
                         '' . "\0" . 'Core\\Model\\TestUser' . "\0" . 'salt',
                         '' . "\0" . 'Core\\Model\\TestUser' . "\0" . 'registerDate',
                         '' . "\0" . 'Core\\Model\\TestUser' . "\0" . 'lastLoginDate',
                         '' . "\0" . 'Core\\Model\\TestUser' . "\0" . 'knowsFrom',
                         '' . "\0" . 'Core\\Model\\TestUser' . "\0" . 'confirmationKey',
                         '' . "\0" . 'Core\\Model\\TestUser' . "\0" . 'ownedCompany',
                         '' . "\0" . 'Core\\Model\\TestUser' . "\0" . 'storage',
