...
class TestUser extends \Core\Model\TestUser implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'findQueryContext', 'id', 'email', 'password', 'name', 'firstname', 'lang', 'salt', 'registerDate', 'lastLoginDate', 'knowsFrom', 'confirmationKey', 'ownedCompany', 'ownedCompanyRestrictedId', 'isOwnedCompanyFaulted', 'storage', 'storageRestrictedId', 'isStorageFaulted', 'company', 'companyRestrictedId', 'isCompanyFaulted');
        }
